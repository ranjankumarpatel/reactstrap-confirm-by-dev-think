...
// Explicit value reference to avoid TS treating component as a type in older plugin contexts
const ConfirmModalComponent = ConfirmModal;
...
export function confirm(options: ConfirmOptions = {}): Promise<boolean> {
  return new Promise((resolve) => {
    ...
    root.render(
      React.createElement(ConfirmModalComponent as any, props)
    );
  });
}
